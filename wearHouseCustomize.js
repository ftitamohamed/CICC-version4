...
// Create array with at least 6 images (repeating if needed)
let repeatedImages = [];
const sourceImages = guidness_pictures.length > 0 ? guidness_pictures : ['1']; // Ensure we have at least one image
...
if (guidness_pictures.length) {
    repeatedImages.forEach((picture) => {
      ...
      element.style.cursor = 'pointer'; // show clickable cursor
      ...
      element.addEventListener('click', () => {
        ...
        // Add clicked image to preview container
        const img = document.createElement('img');
        img.src = picture;
        img.style.cssText = 'max-width: 500px; max-height: 500px;';
